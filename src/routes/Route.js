...
export default function RouteWrapper({
  ...
  if (rest.path === '/programas' || rest.path === '/projetos_submetidos/:id' || rest.path === '/projeto/:id/:coordenador' || rest.path === '/configurar-edital' || rest.path === '/avaliadores/:id' || rest.path === '/editais/:id') {
    path = "Programas";
  }
