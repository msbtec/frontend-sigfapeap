...
function Hospedagens({
  ...
  useEffect(() => {
    if (hospedagem.custo_unitario.length > 0) {
      setHospedagem({ ...hospedagem, custo_total: moeda(String(getValue(hospedagem.custo_unitario) * hospedagem.quantidade)) });
    }
  ...
  return (
    ...
    >
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Hospedagem</h5>
      </div>
      <Form>
