  ...
  return (
    ...
    >
      ...
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">{!item ? 'Cadastrar documento' : 'Atualizar documento'}</h5>
      ...
      <Unform initialData={item} ref={formRef} onSubmit={handleSubmit}>
        ...
        <Form>
          <div className="modal-body" ref={reference}>
            <Input formRef={formRef} name="title" required original title="Nome do documento" />
